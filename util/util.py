...
def visualize(image_name, predictions, weight_name):
    ...
    for (i, pred) in enumerate(predictions):
        ...
        tmp = '/blue/eel6935/share/GAN/RTFNet/runs/Pred_' + weight_name + '_' + image_name[i] + '.png'
        print(tmp)
        img.save('/blue/eel6935/share/GAN/RTFNet/runs/Pred_' + weight_name + '_' + image_name[i] + '.png')
