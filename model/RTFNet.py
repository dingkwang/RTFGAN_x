...
class RTFNet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        # START WITH PRETRAINED WEIGHTS FROM RESNET NETWORKS
        ...
        ########  Thermal ENCODER  ########  
        # BOTTOM BLUE NETWORK IN THE GITHUB PIC
        ...
        ########  RGB ENCODER  ########
        # TOP BLUE NETWORK IN THE GITHUB PIC
        ...
        # THE CODE HERE MAKES BOXES BIGGER
    ...
    # THIS IS HOW THE DATA GOES THROUGH THE NETWORK
    def forward(self, input):
        ...
        # ADDING RESPONSES FROM RGB AND THERMAL TO DO FUSION
        rgb = rgb + thermal
